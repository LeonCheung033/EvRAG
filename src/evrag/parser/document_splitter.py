    ...
    try:
        ...
        for doc in tqdm(raw_docs, desc="Splitting documents"):
            ...
            for group in grouped_chunks:
                ...
                parent_metadata["unique_id"] = parent_id  # 父文档只设置unique_id，不设置parent_id
                parent_doc = Document(
                    page_content=group,
            ...
            save_2_mongo(parent_docs, collection_name=collection_name, mongodb_client=mongodb_client)
            ...
            for chunk in parent_docs:
                ...
                for child_doc in split_docs:
                    ...
                    child_metadata["parent_id"] = chunk.metadata["unique_id"]  # 子文档的parent_id指向父文档的unique_id
                ...
                # 6. 持久化子文档到 MongoDB
                save_2_mongo(reid_split_docs, collection_name=collection_name, mongodb_client=mongodb_client)
