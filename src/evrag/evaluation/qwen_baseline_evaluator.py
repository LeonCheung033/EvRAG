...
class QwenBaselineFAISSRetriever:
    ...
    def __init__(
        ...
        self.base_url = base_url or settings.siliconflow_base_url or "https://api.siliconflow.cn/v1"
        ...
        if faiss_db_path is None:
            faiss_db_path = settings.faiss_qwen_db_path or Path("data/saved_index/faiss_qwen.db")
    ...
    def calculate_summary_metrics(self) -> Dict[str, Any]:
        ...
        summary = {
            ...
            "semantic_keyword_score": {
                "mean": float(np.mean(semantic_keyword_scores)) if semantic_keyword_scores else 0.0,
